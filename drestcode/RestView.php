<?php
/**
    RestView class. Class to get what view will be used. Also, this is an application-wide view file.
    You can put all your view methods here, but do not edit action_view attribute,
    setActionView, and getActionView method.
